...
const getStyles = (colors) => StyleSheet.create({
  ...
  headerTitle: { ...FONTS.titleLg, fontSize: 18 },
  headerSub: { ...FONTS.labelSm, marginTop: 1 },
  jobCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  jobTitle: { ...FONTS.titleMd, marginBottom: 4 },
  ...
  statusText: { ...FONTS.labelSm, fontSize: 10 },
  countBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 3,
  ...
  emptyText: { ...FONTS.labelLg, textAlign: 'center' },
  appCard: { borderRadius: 14, padding: 14, marginBottom: 12 },
  appTopRow: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  avatar: { width: 44, height: 44, borderRadius: 22 },
  avatarFallback: { alignItems: 'center', justifyContent: 'center' },
  avatarInitial: { ...FONTS.titleMd, fontSize: 17 },
  appName: { ...FONTS.titleMd },
  appRole: { ...FONTS.labelMd },
  appTime: { ...FONTS.labelSm, marginTop: 1 },
  appStatusChip: { paddingHorizontal: 9, paddingVertical: 5, borderRadius: 10 },
  appStatusText: { ...FONTS.labelSm, fontSize: 10, fontWeight: '700' },
  coverLetter: {
    ...FONTS.labelLg,
    marginTop: 10,
    paddingTop: 10,
